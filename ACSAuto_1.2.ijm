...
function getlineLength () {
	...
	*/
	...
	if (scaling == "Automatic") {
		...
		n0 = nResults;
		print(n0);
		run("Analyze Particles...", "size=280-Infinity show=Masks");
		n1 = nResults;
		print(n1);
		IJ.deleteRows(n0, n1);
		...
		n0 = nResults;
		print(n0);
		run("Ridge Detection", "line_width=1 high_contrast=128 low_contrast=70 extend_line show_ids displayresults add_to_manager method_for_overlap_resolution=SLOPE sigma=0.79 lower_threshold=9 upper_threshold=18 minimum_line_length=175 maximum=280");
		...
		n0 = nResults;
		run("Analyze Particles...", "size=700-Infinity show=Masks");
		n1 = nResults;
		IJ.deleteRows(n0, n1);
